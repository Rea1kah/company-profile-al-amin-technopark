    ...
    <div className="min-h-screen flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="hidden lg:flex w-[45%] relative overflow-hidden flex-col justify-between p-12"
        ...
        <div className="relative z-10 space-y-3">
          {[
            { icon: '🌿', text: 'Akses informasi lengkap kawasan' },
            { icon: '📰', text: 'Baca berita & kegiatan terkini' },
            { icon: '🌐', text: 'Nikmati Virtual Tour 360°' },
            { icon: '📍', text: 'Eksplorasi peta kawasan interaktif' },
          ].map(({ icon, text }) => (
